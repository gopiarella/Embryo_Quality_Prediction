# -*- coding: utf-8 -*-
"""
Created on Mon Apr 21 10:46:29 2025
...
def load_swin_model(class_count):
...
for day in ['Day 3', 'Day 4', 'Day 5']:
    ...
    model = load_swin_model(len(class_names))
    ...
    print(f"\n👉 Finished training for {day}. Save manually with:\n"
          f"torch.save(model.state_dict(), '{day.replace(' ', '_')}_swin_model.pth')")
    ...
    print(f"✅ Results for {day} (Swin Transformer) saved to {summary_file}")
