# -*- coding: utf-8 -*-
"""
Created on Mon Apr 21 10:49:57 2025
...
def load_vit_model(class_count):
...
for day in ['Day 3', 'Day 4', 'Day 5']:
    ...
    # Using ViT-B_16 Model
    model = load_vit_model(len(class_names))
    ...
    print(f"\n👉 Finished training for {day}. If satisfied, save manually using:\n"
          f"torch.save(model.state_dict(), '{day.replace(' ', '_')}_vit_model.pth')")
    ...
    print(f"✅ Results for {day} (ViT-B_16) saved to {summary_file}")
